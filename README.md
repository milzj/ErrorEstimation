...
## Acknowledgement
We extend our gratitude to Jørgen Schartum Dokken and Henrik Finsberg, the developers of the [Scientific Computing Example Paper](https://github.com/scientificcomputing/example-paper) package.
